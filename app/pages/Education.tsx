	...
	return (
		<ChildContainer>
			<div className="flex flex-col w-[72%] space-y-8">
				<p className="text-black text-lg font-light w-[60%]">
					My journey into tech began in my first year of university, where I
					went from scoring a <span className="font-medium">humble 43%</span> on
					my very first code challenge to topping the class with a standout{" "}
				...
				<div className="flex flex-col">
					<p className="text-black text-lg font-light w-[70%]">
					...
					<div className="flex flex-row space-x-20 w-full">
						<div className="flex flex-row items-center space-x-2">
							...
							<p className="text-black"> I’m pretty good at this</p>
						</div>
				...
				<p className="text-black text-lg font-light w-[70%]">
					...
					<span
						className="font-medium underline text-forest cursor-pointer"
						onClick={() =>
							setCurrentPdf({
